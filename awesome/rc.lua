...
globalkeys = awful.util.table.join(
    ...
    awful.key({modkey,}, "q", shifty.rename), -- rename a tag
    ...
    awful.key({modkey, "Control"}, "Return", function() awful.util.spawn("konsole --profile 'tobru mgmt'") end),
    -- awful.key({modkey, "Control"}, "Return", function() awful.util.spawn("terminator -p tobrumgmt") end),
    awful.key({modkey, "Control" }, "w", function () awful.util.spawn("firefox -no-remote -profilemanager") end),
    awful.key({modkey, "Control"}, "r", awesome.restart),
    awful.key({modkey, "Shift"}, "q", awesome.quit),

    -- awful.key({modkey,}, "l", function() awful.tag.incmwfact(0.05) end),
    awful.key({ modkey,}, "l", function () awful.util.spawn("qdbus org.freedesktop.ScreenSaver /ScreenSaver Lock") end),
